...
import fr.rif.demo.store.domain.ProductCategory;
import fr.rif.demo.store.repository.ProductCategoryRepository;
import fr.rif.demo.store.service.ProductCategoryService;
...
/**
 * REST controller for managing {@link fr.rif.demo.store.domain.ProductCategory}.
 */
@RestController
@RequestMapping("/api")
