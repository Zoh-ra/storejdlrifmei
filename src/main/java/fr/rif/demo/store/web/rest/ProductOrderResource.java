...
import fr.rif.demo.store.repository.ProductOrderRepository;
import fr.rif.demo.store.service.ProductOrderService;
...
/**
 * REST controller for managing {@link fr.rif.demo.store.domain.ProductOrder}.
 */
@RestController
@RequestMapping("/api")
