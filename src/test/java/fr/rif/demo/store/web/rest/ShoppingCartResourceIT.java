...
import static fr.rif.demo.store.web.rest.TestUtil.sameNumber;
...
import fr.rif.demo.store.domain.enumeration.OrderStatus;
import fr.rif.demo.store.domain.enumeration.PaymentMethod;
import fr.rif.demo.store.repository.ShoppingCartRepository;
