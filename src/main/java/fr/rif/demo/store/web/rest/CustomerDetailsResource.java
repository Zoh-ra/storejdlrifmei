...
import fr.rif.demo.store.domain.CustomerDetails;
import fr.rif.demo.store.repository.CustomerDetailsRepository;
import fr.rif.demo.store.service.CustomerDetailsService;
...
/**
 * REST controller for managing {@link fr.rif.demo.store.domain.CustomerDetails}.
 */
@RestController
@RequestMapping("/api")
public class CustomerDetailsResource {
    ...
    public ResponseEntity<List<CustomerDetails>> getAllCustomerDetails(@org.springdoc.api.annotations.ParameterObject Pageable pageable) {
